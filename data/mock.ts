...
export const BOATS: MockBoat[] = [
  {
    ...
    img: IMG.cat6,
    gallery: [IMG.cat6, IMG.cat1, IMG.int1, IMG.int2, IMG.cat2, IMG.cat3, IMG.cat4],
    prices: PRICE_IVAN,
  ...
  },
  {
    ...
    img: IMG.cat1,
    gallery: [IMG.cat1, IMG.cat6, IMG.int1, IMG.int2, IMG.cat2, IMG.cat5, IMG.cat4],
    prices: PRICE_AYZA,
    equipment: LAGOON42_EQUIPMENT,
    optional: [
      { name: "Skipper", price: "€200 / gün", note: "Deneyimli kaptan" },
  ...
  },
  {
    ...
    img: IMG.cat4,
    gallery: [IMG.cat4, IMG.cat3, IMG.int2, IMG.int1, IMG.cat5, IMG.cat2, IMG.cat6],
    prices: PRICE_RENA,
  ...
  },
  {
    ...
    img: IMG.cat2,
    gallery: [IMG.cat2, IMG.cat1, IMG.cat5, IMG.cat3, IMG.cat6, IMG.int1, IMG.int2],
