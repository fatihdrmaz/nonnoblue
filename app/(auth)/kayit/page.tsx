...
export default function KayitPage() {
  ...
  return (
    ...
    >
      ...
      >
        E-posta adresinize kayıt bağlantısı göndereceğiz
      </p>
      ...
      {sent ? (
        ...
        >
          ...
          >
            Kayıt bağlantısı gönderildi! E-postanızı onaylayın.
          </p>
        </div>
      ) : (
        <form onSubmit={handleSignup} style={{ marginBottom: '1.25rem' }}>
          <label
            htmlFor="email"
            style={{
              display: 'block',
