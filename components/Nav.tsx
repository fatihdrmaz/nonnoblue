...
export function Nav() {
  ...
  const navLinks = [
    { href: '/filo', label: t('fleet') },
    { href: '/rotalar', label: t('routes') },
    ...
    <>
        ...
        <div className="container nb-nav-inner">
          ...
          <div className="nb-nav-actions">
            ...
            {isLoggedIn ? (
              ...
              <Link href="/giris" className="btn btn-sm" style={{
                border: '1.5px solid rgba(255,255,255,0.5)',
                color: transparent ? '#fff' : 'var(--ink)',
                background: 'transparent',
                fontWeight: 600,
            ...
            <button className="nb-mobile" onClick={() => setMenuOpen(true)} aria-label="Menu">
      ...
      <a
        ...
        onMouseEnter={e => {
          ...
          (e.currentTarget as HTMLAnchorElement).style.boxShadow = '0 6px 24px rgba(37,211,102,.6)';
        }}
        onMouseLeave={e => {
          (e.currentTarget as HTMLAnchorElement).style.transform = 'scale(1)';
          (e.currentTarget as HTMLAnchorElement).style.boxShadow = '0 4px 16px rgba(37,211,102,.45)';
        }}
      >
        ...
        <div className="nb-mobile-panel" onClick={() => setMenuOpen(false)}>
          <div className="nb-mobile-inner" onClick={e => e.stopPropagation()}>
            ...
            <a
              ...
              style={{ display: 'flex', alignItems: 'center', gap: 10, color: '#25d366', fontWeight: 600, fontSize: 15, textDecoration: 'none' }}
            >
